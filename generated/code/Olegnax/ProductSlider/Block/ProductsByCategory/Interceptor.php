<?php
namespace Olegnax\ProductSlider\Block\ProductsByCategory;

/**
 * Interceptor class for @see \Olegnax\ProductSlider\Block\ProductsByCategory
 */
class Interceptor extends \Olegnax\ProductSlider\Block\ProductsByCategory implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Framework\View\LayoutFactory $layoutFactory, \Magento\Framework\Serialize\Serializer\Json $json, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $urlHelper, $layoutFactory, $json, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initProductCollection');
        return $pluginInfo ? $this->___callPlugins('initProductCollection', func_get_args(), $pluginInfo) : parent::initProductCollection();
    }
    ...
    public function getCacheKeyInfo($newval = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCacheKeyInfo', func_get_args(), $pluginInfo) : parent::getCacheKeyInfo($newval);
    }
     ...
     * {@inheritdoc}
     */
    public function addAttributeToSort(\Magento\Catalog\Model\ResourceModel\Product\Collection $collection, $order_attribute = '', $order_dir = 'ASC')
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAttributeToSort');
        return $pluginInfo ? $this->___callPlugins('addAttributeToSort', func_get_args(), $pluginInfo) : parent::addAttributeToSort($collection, $order_attribute, $order_dir);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCarouselOptions');
        return $pluginInfo ? $this->___callPlugins('getCarouselOptions', func_get_args(), $pluginInfo) : parent::getCarouselOptions($options, $json);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnderlineNameInLayout');
        return $pluginInfo ? $this->___callPlugins('getUnderlineNameInLayout', func_get_args(), $pluginInfo) : parent::getUnderlineNameInLayout();
    }

    /**
     * {@inheritdoc}
     */
    public function getMSRPHtml(\Magento\Catalog\Model\Product $product)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMSRPHtml');
        return $pluginInfo ? $this->___callPlugins('getMSRPHtml', func_get_args(), $pluginInfo) : parent::getMSRPHtml($product);
    }

    /**
     * {@inheritdoc}
     */
    public function isMSRP(\Magento\Catalog\Model\Product $product)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isMSRP');
        return $pluginInfo ? $this->___callPlugins('isMSRP', func_get_args(), $pluginInfo) : parent::isMSRP($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMSRP');
        return $pluginInfo ? $this->___callPlugins('getMSRP', func_get_args(), $pluginInfo) : parent::getMSRP();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLazyImage');
        return $pluginInfo ? $this->___callPlugins('getLazyImage', func_get_args(), $pluginInfo) : parent::getLazyImage($product, $imageId, $attributes);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannersData');
        return $pluginInfo ? $this->___callPlugins('getBannersData', func_get_args(), $pluginInfo) : parent::getBannersData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGridBanner');
        return $pluginInfo ? $this->___callPlugins('getGridBanner', func_get_args(), $pluginInfo) : parent::getGridBanner($block_id);
    }
