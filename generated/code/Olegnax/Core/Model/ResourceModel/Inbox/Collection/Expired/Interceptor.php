<?php
namespace Olegnax\Core\Model\ResourceModel\Inbox\Collection\Expired;

/**
 * Interceptor class for @see \Olegnax\Core\Model\ResourceModel\Inbox\Collection\Expired
 */
class Interceptor extends \Olegnax\Core\Model\ResourceModel\Inbox\Collection\Expired implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addRemoveFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRemoveFilter', func_get_args(), $pluginInfo) : parent::addRemoveFilter();
    }
