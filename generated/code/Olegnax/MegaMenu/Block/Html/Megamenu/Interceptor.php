<?php
namespace Olegnax\MegaMenu\Block\Html\Megamenu;

/**
 * Interceptor class for @see \Olegnax\MegaMenu\Block\Html\Megamenu
 */
class Interceptor extends \Olegnax\MegaMenu\Block\Html\Megamenu implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getValueOption($path, $default = '')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getValueOption', func_get_args(), $pluginInfo) : parent::getValueOption($path, $default);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSystemValue');
        return $pluginInfo ? $this->___callPlugins('getSystemValue', func_get_args(), $pluginInfo) : parent::getSystemValue($path, $storeCode);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getModuleMediaUrl');
        return $pluginInfo ? $this->___callPlugins('getModuleMediaUrl', func_get_args(), $pluginInfo) : parent::getModuleMediaUrl($path);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareStyle');
        return $pluginInfo ? $this->___callPlugins('prepareStyle', func_get_args(), $pluginInfo) : parent::prepareStyle($style, $separatorValue, $separatorAttribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareAttributes');
        return $pluginInfo ? $this->___callPlugins('prepareAttributes', func_get_args(), $pluginInfo) : parent::prepareAttributes($attributes);
    }
    ...
    public function addIdentity($identity)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIdentity', func_get_args(), $pluginInfo) : parent::addIdentity($identity);
    }
