<?php
namespace Olegnax\Athlete2\Block\Product\SalePriceDifference;

/**
 * Interceptor class for @see \Olegnax\Athlete2\Block\Product\SalePriceDifference
 */
class Interceptor extends \Olegnax\Athlete2\Block\Product\SalePriceDifference implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Pricing\Helper\Data $priceHelper, \Olegnax\Athlete2\Helper\Helper $helper, \Magento\Framework\Escaper $escaper, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $priceHelper, $helper, $escaper, $data);
    }

    /**
     * {@inheritdoc}
     */
    public function getSalePriceDifference(\Magento\Catalog\Model\Product $product)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSalePriceDifference');
        return $pluginInfo ? $this->___callPlugins('getSalePriceDifference', func_get_args(), $pluginInfo) : parent::getSalePriceDifference($product);
    }

    /**
     * {@inheritdoc}
     */
    public function getSalePriceSimple(\Magento\Catalog\Model\Product $product, $showAsPercent)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSalePriceSimple');
        return $pluginInfo ? $this->___callPlugins('getSalePriceSimple', func_get_args(), $pluginInfo) : parent::getSalePriceSimple($product, $showAsPercent);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceDiffTag');
        return $pluginInfo ? $this->___callPlugins('getPriceDiffTag', func_get_args(), $pluginInfo) : parent::getPriceDiffTag($priceDifference, $formatPrice);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceTag');
        return $pluginInfo ? $this->___callPlugins('getPriceTag', func_get_args(), $pluginInfo) : parent::getPriceTag($priceDifference, $format);
    }
    ...
    public function getConfig($path, $storeCode = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfig', func_get_args(), $pluginInfo) : parent::getConfig($path, $storeCode);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigShowPriceAsPercent');
        return $pluginInfo ? $this->___callPlugins('getConfigShowPriceAsPercent', func_get_args(), $pluginInfo) : parent::getConfigShowPriceAsPercent();
    }
