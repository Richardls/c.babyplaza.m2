<?php
namespace Olegnax\Athlete2\Block\Product\View;

/**
 * Interceptor class for @see \Olegnax\Athlete2\Block\Product\View
 */
class Interceptor extends \Olegnax\Athlete2\Block\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockTemplateProcessor');
        return $pluginInfo ? $this->___callPlugins('getBlockTemplateProcessor', func_get_args(), $pluginInfo) : parent::getBlockTemplateProcessor($content, $store_id);
    }
